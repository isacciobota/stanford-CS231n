...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
          forward_pass, backward_pass = rnn_forward, rnn_backward
        if self.cell_type == 'lstm':  
          forward_pass, backward_pass = lstm_forward, lstm_backward
        ...
        # Step (3)
        h, cache_h = forward_pass(x, h0, Wx, Wh, b)
        # Step (4)
        ...
        dx, dh0, grads["Wx"], grads["Wh"], grads["b"] = backward_pass(dh, cache_h)
